...
SELECT 
	h.paquete -> 'datos' ->> 'creditos' as creditos, 
	h.paquete -> 'datos' ->> 'ganado' as ganado,
	h.paquete -> 'datos' ->> 'apostado' as apostado,
	h.paquete -> 'datos' ->> 'apostadoEnCicloDeBolasExtra' as apostadoEnBolasExtra,
	h.paquete -> 'datos' ->> 'apostadoEnBolasExtra', 
	h.paquete -> 'datos' ->> 'huboBonus' as huboBonus 
